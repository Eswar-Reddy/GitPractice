...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>CustomAppResults</application>
    ...
    <layoutAssignments>
        <layout>Mobile_Settting__mdt-Mobile Settting Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>ApxPage1</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>ApxPage2</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
